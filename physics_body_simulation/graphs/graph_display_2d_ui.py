...
from graphs.graph_elements_2d_ui import Group2D

from PyQt5 import QtCore, QtWidgets

class GraphDisplay2D_UI(QtCore.QObject):
    ...
    def setup_graph_display_2d(self, centralwidget, particle_values, number_of_plots):
        ...
        self.graph_display_2d_frame = create.create_frame(
            parent = centralwidget,
            geometry = QtCore.QRect(9, 9, 948, 520),
            fshape = QtWidgets.QFrame.WinPanel,
            fshadow = QtWidgets.QFrame.Plain,
            objname = "graph_display_2d_frame"
        )
        self.graph_display_scrollarea = create.create_scroll(
            parent = self.graph_display_2d_frame,
        ...
        if number_of_plots >= 1:
            self.graph1 = Group2D(self.displayed_checkboxes, 1)
        ...
        if number_of_plots >= 2:
            self.graph2 = Group2D(self.displayed_checkboxes, 2)
        ...
        if number_of_plots >= 3:
            self.graph3 = Group2D(self.displayed_checkboxes, 3)
        ...
        if number_of_plots == 4:
            self.graph4 = Group2D(self.displayed_checkboxes, 4)

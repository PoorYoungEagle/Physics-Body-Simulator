...
import utils.resolution_scaler as scaler
...
class RandomParticle_UI:
    def __init__(self):
        ...
        self.scaler = scaler.ResolutionScaler()
    ...
    def _set_color_type(self, type):
        ...
        if type == "Custom":
            self.rules_single_variable_frame.setGeometry(self.scaler.scale_rect(QtCore.QRect(630, 120, 301, 365)))
            self.color_button_lower.show()
            self.color_button_upper.show()
            self.color_hyphen_label.show()
        else:
            self.rules_single_variable_frame.setGeometry(self.scaler.scale_rect(QtCore.QRect(630, 120, 301, 321)))

    ...
    def hide_show_settings(self):
        ...
        if self.indicator == 0:
            ...
            if self.dimension == "2D":
                ...
                self.graph_display_2d_ui.graph_display_2d_frame.setGeometry(self.scaler.scale_rect(QtCore.QRect(10, 10, 940, 1068)))
                self.graph_display_2d_ui.graph_display_scrollarea.setGeometry(self.scaler.scale_rect(QtCore.QRect(11, 2, 928, 1061)))
                self.graph_display_2d_ui.graph_display_scroll_widget.setGeometry(self.scaler.scale_rect(QtCore.QRect(0, 0, 926, 1061)))
            else:
                self.graph_display_3d_ui.graph_settings_3d_frame.hide()
                self.hide_settings_button.setText("Show Settings")
                self.graph_display_3d_ui.graph_display_3d_frame.setGeometry(self.scaler.scale_rect(QtCore.QRect(10, 10, 940, 1068)))
                self.graph_display_3d_ui.graph_display_scrollarea.setGeometry(self.scaler.scale_rect(QtCore.QRect(11, 2, 928, 1061)))
                self.graph_display_3d_ui.graph_display_scroll_widget.setGeometry(self.scaler.scale_rect(QtCore.QRect(0, 0, 926, 1061)))
            return
        ...
        if self.indicator == 1:
            ...
            if self.dimension == "2D":
                ...
                self.graph_display_2d_ui.graph_display_2d_frame.setGeometry(self.scaler.scale_rect(QtCore.QRect(9, 9, 948, 520)))
                self.graph_display_2d_ui.graph_display_scrollarea.setGeometry(self.scaler.scale_rect(QtCore.QRect(11, 2, 928, 514)))
                self.graph_display_2d_ui.graph_display_scroll_widget.setGeometry(self.scaler.scale_rect(QtCore.QRect(0, 0, 926, 515)))
            else:
                self.graph_display_3d_ui.graph_settings_3d_frame.show()
                self.hide_settings_button.setText("Hide Settings")
                self.graph_display_3d_ui.graph_display_3d_frame.setGeometry(self.scaler.scale_rect(QtCore.QRect(9, 9, 948, 520)))
                self.graph_display_3d_ui.graph_display_scrollarea.setGeometry(self.scaler.scale_rect(QtCore.QRect(11, 2, 928, 514)))
                self.graph_display_3d_ui.graph_display_scroll_widget.setGeometry(self.scaler.scale_rect(QtCore.QRect(0, 0, 926, 515)))
            return
